/*
    This file is part of Repetier-Firmware 0.83.
...
*/
    ...
    #define XAXIS_STEPS_PER_MM 80.273
    /** \brief Number of steps for a 1mm move in y direction.
    For xy gantry use 2*belt moved!
    Overridden if EEPROM activated.*/
    #define YAXIS_STEPS_PER_MM 79.701
...
#define EXT0_STEPS_PER_MM 1013 //385
...
#define EXT0_PID_P   2.64
/** I-gain. Overridden if EEPROM activated.
*/
#define EXT0_PID_I   0.06
/** Dgain.  Overridden if EEPROM activated.*/
#define EXT0_PID_D 29.86
// maximum time the heater is can be switched on. Max = 255.  Overridden if EEPROM activated.
#define EXT0_PID_MAX 128  //QB  
...
*/
/** Number of entries in the user thermistortable. Set to 0 to disable it. */
...
#define NUM_TEMPS_USERTHERMISTOR1 20  //100k termistor RS 198-961 (4.7K pullup)
#define USER_THERMISTORTABLE1  {\
   {1*4, 929*8},{54*4, 266*8},{107*4, 217*8},{160*4, 190*8},{213*4, 172*8},{266*4, 158*8},{319*4, 146*8},{372*4, 136*8},\
   {425*4, 127*8},{478*4, 119*8},{531*4, 111*8},{584*4, 103*8},{637*4, 96*8},{690*4, 88*8},{743*4, 80*8},{796*4, 71*8},\
...
#define GENERIC_THERM2_R2 10000
...
/** P-gain.  Overridden if EEPROM activated. */
#define HEATED_BED_PID_PGAIN   256.27
/** I-gain  Overridden if EEPROM activated.*/
#define HEATED_BED_PID_IGAIN   113.27
/** Dgain.  Overridden if EEPROM activated.*/
#define HEATED_BED_PID_DGAIN 144.95
// maximum time the heater is can be switched on. Max = 255.  Overridden if EEPROM activated.
